        ...
        while (true) {
            ...
            while (true) {
                ...
                if (doSearch.equals("N")) {
                    ...
                    System.out.println("Write specific information that you want to find with comma like that - 'power,100'.\nYou have next options: Car (power, model, year), Book (author, name, pages), RootCrop (type, weight, color).");
